...
//       // Remove from localStorage quantity as well
//       let saved = JSON.parse(localStorage.getItem("cartQuantities") || "{}");
...
//                 <p className="text-gray-600 text-sm group-hover:underline">{product.type}</p>
