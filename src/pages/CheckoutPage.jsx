...
const CheckoutPage = () => {
  ...
  if (loading)
    return <p className="text-center mt-10 text-gray-700">Loading checkout...</p>;
      ...
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
        <div className="p-8 lg:p-10 bg-gray-50 border-r border-gray-100">
          ...
          <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
            {products.map((p) => (
              <div key={p.id} className="flex items-center gap-4 p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition">
                {p.image ? (
                  <img
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-3">
                {["Credit / Debit Card", "UPI / NetBanking", "Cash on Delivery"].map((method, i) => (
                  <label
                    key={i}
