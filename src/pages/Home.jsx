  ...
  return (
    <div className="relative h-[75vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-full px-4">
        ...
        <p className="text-base sm:text-lg md:text-xl text-blue-900/90 mb-6 max-w-4xl leading-relaxed font-medium bg-white/70 px-4 py-2 rounded-lg shadow-sm backdrop-blur-sm">
