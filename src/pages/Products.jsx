...
const Filters = ({
  ...
  const dropdownClass =
    "absolute left-0 top-full mt-2 bg-white shadow-lg rounded-lg py-2 z-40 border w-48 max-h-56 overflow-y-auto";
  ...
  return (
    <div
      className="
        ...
        gap-4 py-4 px-1 mb-6
        scrollbar-thin scrollbar-thumb-gray-300
        max-w-full
      "
    >
      {/* TYPE */}
      <div className="relative filter-dropdown inline-block">
        <button
          onClick={() => toggleMenu("type")}
          className="px-4 py-2 bg-white rounded-lg shadow-sm hover:bg-gray-100"
        >
      ...
      <input
        type="number"
        placeholder="Price"
        className="border px-3 py-2 w-32 rounded-lg shadow-sm"
        value={filterPrice}
        onChange={(e) => setFilterPrice(e.target.value)}
      />
      ...
      <div className="relative filter-dropdown inline-block">
        ...
        {openMenu === "price" && (
          <div className={dropdownClass}>
            <div className={itemClass} onClick={() => { setPriceFilterType("less"); closeAll(); }}>Less Than</div>
            <div className={itemClass} onClick={() => { setPriceFilterType("greater"); closeAll(); }}>Greater Than</div>
          </div>
        )}
      </div>
      ...
      <button
        onClick={resetFilters}
        className="px-4 py-2 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 whitespace-nowrap"
      >
        Reset
      </button>
    </div>
