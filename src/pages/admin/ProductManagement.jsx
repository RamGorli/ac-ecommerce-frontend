...
const ProductManagement = () => {
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    description: "",
    image: null, // Base64 only (no prefix)
  });
  ...
  // ✅ Handle image upload safely (remove data URL prefix)
  const handleImageChange = (e) => {
    ...
    reader.onloadend = () => {
      ...
      setPreview(result); // keep full for preview
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const productPayload = {
        ...
        image: form.image, // pure base64 string
      };
